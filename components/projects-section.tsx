...
const iconMap: { icon: LucideIcon; color: string; bgColor: string; borderColor: string; technologies: string[]; category: string }[] = [
  {
    icon: CreditCard,
...
const filters = [
  ...
  { id: "telecommunications", icon: Phone },
                    ...
                    <div className={`absolute inset-0 w-full min-h-full h-auto bg-white dark:bg-gray-900 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow border ${borderColor} [backface-visibility:hidden] flex flex-col`}>
                      ...
                      <div className="flex flex-wrap gap-2 mb-6">
                        {(Array.isArray(project.technologies) && project.technologies.length > 0
                          ...
                          : iconMap[globalIdx % iconMap.length]?.technologies || [])
